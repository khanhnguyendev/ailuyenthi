...
export function MobileNav() {
    ...
    // Custom Sheet implementation since I'm not sure if user has ShadCN Sheet installed and configured 
    // actually, let's build a custom one to be safe and consistent with the glass theme plan
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed inset-y-0 left-0 w-[80%] max-w-sm bg-background/95 backdrop-blur-xl border-r border-border z-50 overflow-y-auto"
                        >
                            <div className="p-6">
