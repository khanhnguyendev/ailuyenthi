        ...
        <div className="max-w-5xl mx-auto space-y-12 pb-20 pt-10 px-6">
            ...
            <section className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-bold text-foreground">Choose Practice Mode</h2>
                    <span className="text-sm text-muted-foreground">Recommended for you</span>
                </div>
                <PracticeSelector />
            </section>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
                ...
                <div className="glass p-6 rounded-2xl border border-red-500/20">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="font-bold text-foreground text-lg">Focus Areas</h3>
                    </div>

                    <div className="space-y-4">
                        <div className="bg-secondary/50 p-4 rounded-xl border border-border">
                            <div className="flex justify-between text-sm mb-2">
                                <span className="font-bold text-foreground">True / False / Not Given</span>
                                <span className="text-red-500 font-bold">42% Accuracy</span>
                            </div>
                        ...
                        <div className="bg-secondary/50 p-4 rounded-xl border border-border">
                            <div className="flex justify-between text-sm mb-2">
                                <span className="font-bold text-foreground">Matching Headings</span>
                                <span className="text-orange-500 font-bold">65% Accuracy</span>
                            </div>
                            <div className="w-full bg-secondary h-1.5 rounded-full overflow-hidden">
                ...
                <div className="glass p-6 rounded-2xl">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="flex justify-between items-center p-3 hover:bg-accent/50 rounded-xl transition-colors cursor-pointer group">
                                <div>
                                    <h4 className="font-bold text-foreground text-sm">{item.mode}</h4>
                                    <span className="text-xs text-muted-foreground">{item.date}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <span className="font-mono text-sm font-bold text-blue-500">{item.score}</span>
